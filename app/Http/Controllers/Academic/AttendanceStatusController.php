...
class AttendanceStatusController extends CollegeBaseController
{
    ...
    protected $view_path = 'academic.status.attendance-status';
    protected $panel;
    protected $filter_query = [];

    public function __construct()
    {
        $this->panel = __('academic.child.status_setting.child.attendance_status');
    }

    public function index(Request $request)
    {
        $data = [];
        $data['attendance-status'] = AttendanceStatus::get();
