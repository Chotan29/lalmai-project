...
class ExamMarkLedgerController extends CollegeBaseController
{
    ...
    {
        $main = Subject::find($mainSubjectId);
    ...
    /*Kept as thin wrappers so the matching rule lives in ONE place (Subject model).*/
    public function subjectTitleParts($title)
    {
        return Subject::titleParts($title);
    }

    public function sameSubjectName($titleA, $titleB)
    {
        return Subject::sameName($titleA, $titleB);
    }
