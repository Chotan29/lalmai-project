...
class PayrollBaseController extends CollegeBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $data['salaryPay'] = SalaryPay::select('salary_pays.staff_id', 'salary_pays.salary_masters_id', 'salary_pays.date',
            'salary_pays.allowance', 'salary_pays.fine', 'salary_pays.paid_amount','salary_pays.payment_method',
            ...
            ->where(function ($query) use ($request) {
                ...
                if ($request->has('payment_method') && $request->get('payment_method') !=null) {
                    $query->where('salary_pays.payment_method', 'like', '%' . $request->payment_method . '%');
                    $this->filter_query['salary_pays.payment_method'] = $request->payment_method;
                }
