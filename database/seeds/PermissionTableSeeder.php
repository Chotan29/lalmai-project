    ...
    public function run()
    {
        ...
        /*Student Menu*/
            ...
            [
                ...
                'description' => 'Routine Student Menu'
            ],
            [
                'group'=>'Student Menu',
                'name' => 'student-notice',
...
//            ],
        ...
        /* Class Routine */
            [
                ...
                'name'         => 'routine-index',
                'display_name' => 'Index',
                'description'  => 'List/View Class Routines'
            ],
            [
                'group'        => 'Class Routine',
                'name'         => 'routine-add',
            ...
            [
                ...
                'name'         => 'routine-view',
                'display_name' => 'Show',
                'description'  => 'View a single Class Routine'
            ],
            [
                'group'        => 'Class Routine',
                'name'         => 'routine-edit',
                'display_name' => 'Edit',
                'description'  => 'Edit/Update Class Routine'
            ],
            [
                'group'        => 'Class Routine',
                'name'         => 'routine-delete',
                'display_name' => 'Delete',
                'description'  => 'Delete Class Routine'
            ],
            [
                'group'        => 'Class Routine',
                'name'         => 'routine-manage',
                'display_name' => 'Manage',
                'description'  => 'Access composite scheduler (manage/schedules/existing/save)'
            ],
            [
                'group'        => 'Class Routine',
                'name'         => 'routine-import',
                'display_name' => 'Import',
                'description'  => 'Import Class Routines from file'
            ],
            [
                'group'        => 'Class Routine',
                'name'         => 'routine-export',
                'display_name' => 'Export',
                'description'  => 'Export routines / download template'
            ],
            [
                'group'        => 'Class Routine',
                'name'         => 'routine-print',
                'display_name' => 'Print',
                'description'  => 'Print routines by Department/Faculty/Semester/Batch/Subject'
            ],
...
/*Dynamic Degree*/
        ...
        /*Attendance Group*/
            [
                ...
                // ===== Attendance: Live / Scan / Marking =====
                ['group' => 'Attendance', 'name' => 'attendance-live-index',            'display_name' => 'Live Index',             'description' => 'Attendance Live Index'],
                ['group' => 'Attendance', 'name' => 'attendance-live-students',         'display_name' => 'Live Students',          'description' => 'Attendance Live Students'],
                ['group' => 'Attendance', 'name' => 'attendance-live-staff',            'display_name' => 'Live Staff',             'description' => 'Attendance Live Staff'],
                ['group' => 'Attendance', 'name' => 'attendance-live-list',             'display_name' => 'Live List',              'description' => 'Attendance Live List'],

                ['group' => 'Attendance', 'name' => 'attendance-scan',                  'display_name' => 'Scan',                   'description' => 'Attendance Scan'],
                ['group' => 'Attendance', 'name' => 'attendance-identify',              'display_name' => 'Identify',               'description' => 'Attendance Identify'],

                ['group' => 'Attendance', 'name' => 'attendance-row-mark',              'display_name' => 'Row Mark',               'description' => 'Attendance Row Mark'],
                ['group' => 'Attendance', 'name' => 'attendance-row-check',             'display_name' => 'Row Check',              'description' => 'Attendance Row Check'],

                ['group' => 'Attendance', 'name' => 'attendance-quick-mark',            'display_name' => 'Quick Mark',             'description' => 'Attendance Quick Mark'],
                ['group' => 'Attendance', 'name' => 'attendance-quick-check',           'display_name' => 'Quick Check',            'description' => 'Attendance Quick Check'],

                ['group' => 'Attendance', 'name' => 'attendance-bulk-mark',             'display_name' => 'Bulk Mark',              'description' => 'Attendance Bulk Mark'],
                ['group' => 'Attendance', 'name' => 'attendance-bulk-check',            'display_name' => 'Bulk Check',             'description' => 'Attendance Bulk Check'],



                // ===== Dashboards =====
                ['group' => 'Attendance Dashboard', 'name' => 'attendance-dashboard-students-index',   'display_name' => 'Dashboard Students Index',   'description' => 'Attendance Dashboard Students Index'],
                ['group' => 'Attendance Dashboard', 'name' => 'attendance-dashboard-students-summary', 'display_name' => 'Dashboard Students Summary', 'description' => 'Attendance Dashboard Students Summary'],
                ['group' => 'Attendance Dashboard', 'name' => 'attendance-dashboard-staff-index',      'display_name' => 'Dashboard Staff Index',      'description' => 'Attendance Dashboard Staff Index'],
                ['group' => 'Attendance Dashboard', 'name' => 'attendance-dashboard-staff-summary',    'display_name' => 'Dashboard Staff Summary',    'description' => 'Attendance Dashboard Staff Summary'],

                // ===== Reports: Monthly =====
                ['group' => 'Monthly Report', 'name' => 'attendance-reports-students-monthly',       'display_name' => 'Reports Students Monthly',       'description' => 'Attendance Reports Students Monthly'],
                ['group' => 'Monthly Report', 'name' => 'attendance-reports-students-monthly-data',  'display_name' => 'Reports Students Monthly Data',  'description' => 'Attendance Reports Students Monthly Data'],
                ['group' => 'Monthly Report', 'name' => 'attendance-reports-staff-monthly',          'display_name' => 'Reports Staff Monthly',          'description' => 'Attendance Reports Staff Monthly'],
                ['group' => 'Monthly Report', 'name' => 'attendance-reports-staff-monthly-data',     'display_name' => 'Reports Staff Monthly Data',     'description' => 'Attendance Reports Staff Monthly Data'],

                // ===== Reports: Individual =====
                ['group' => 'Report Card', 'name' => 'attendance-reports-individual-students',    'display_name' => 'Reports Individual Students',    'description' => 'Attendance Reports Individual Students'],
                ['group' => 'Report Card', 'name' => 'attendance-reports-individual-staff',       'display_name' => 'Reports Individual Staff',       'description' => 'Attendance Reports Individual Staff'],
                ['group' => 'Report Card', 'name' => 'attendance-reports-individual-search',      'display_name' => 'Reports Individual Search',      'description' => 'Attendance Reports Individual Search'],
                ['group' => 'Report Card', 'name' => 'attendance-reports-individual-data',        'display_name' => 'Reports Individual Data',        'description' => 'Attendance Reports Individual Data'],
                ['group' => 'Report Card', 'name' => 'attendance-reports-individual-subjects',    'display_name' => 'Reports Individual Subjects',    'description' => 'Attendance Reports Individual Subjects'],

                // ===== Tipsoi (Devices) =====
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-dashboard',                 'display_name' => 'Dashboard',              'description' => 'Tipsoi Dashboard'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-devices-index',             'display_name' => 'Devices Index',          'description' => 'Tipsoi Devices Index'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-search',                    'display_name' => 'Search',                 'description' => 'Tipsoi Search'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-sdk-push-person',           'display_name' => 'SDK Push Person',        'description' => 'Tipsoi SDK Push Person'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-allocations-batch',         'display_name' => 'Allocations Batch',      'description' => 'Tipsoi Allocations Batch'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-runs-store',                'display_name' => 'Runs Store',             'description' => 'Tipsoi Runs Store'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-runs-show',                 'display_name' => 'Runs Show',              'description' => 'Tipsoi Runs Show'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-batch-update',              'display_name' => 'Batch Update',           'description' => 'Tipsoi Batch Update'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-logs-store',                'display_name' => 'Logs Store',             'description' => 'Tipsoi Logs Store'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-logs-test',                 'display_name' => 'Logs Test',              'description' => 'Tipsoi Logs Test'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-status',                    'display_name' => 'Status',                 'description' => 'Tipsoi Status'],
                ['group' => 'Biometric Device Tipsoi Mgmt',     'name' => 'tipsoi-sdk-heartbeat',             'display_name' => 'SDK Heartbeat',          'description' => 'Tipsoi SDK Heartbeat'],
    ...
    [
        ...
        foreach ($permissions as $value) {
            Permission::updateOrCreate(
                ['name' => $value['name']], // match on name
                [
                    'group'        => $value['group'],
                    'display_name' => $value['display_name'],
                    'description'  => $value['description'],
                    // include 'group_head' if it exists in this permission array
                    'group_head'   => isset($value['group_head']) ? $value['group_head'] : '',
                ]
            );
        }
