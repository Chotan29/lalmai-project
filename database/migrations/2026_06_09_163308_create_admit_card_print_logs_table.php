...
class CreateAdmitCardPrintLogsTable extends Migration
{
    public function up()
    {
        /* The table exists on the databases where it was created by hand before this file was
           written, and without this guard `migrate` stops dead there - taking every later
           migration with it. */
        if (Schema::hasTable('admit_card_print_logs')) {
            return;
        }
