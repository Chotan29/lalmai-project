                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ route($base_route.'.edit', ['id' => encrypt($note->id)]) }}" class="btn-success btn-sm">
                                                <i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => encrypt($note->id)]) }}" class="btn-danger btn-sm bootbox-confirm" >
