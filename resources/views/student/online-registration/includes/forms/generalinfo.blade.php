...
@if(Config::get('edufirmconfig.student.online_registration.tabs.general_info.general_info') == 1)
    <fieldset>
        ...
        <div class="form-group">
            {!! Form::label('first_name', __('form_fields.student.fields.name_of_student'), ['class' => 'col-sm-1 control-label',]) !!}
            <div class="col-sm-2">
        ...
        <div class="form-group">
            {!! Form::label('national_id_3', __('form_fields.student.fields.national_id_3'), ['class' => 'col-sm-1 control-label']) !!}
            <div class="col-sm-2">
            ...
            {!! Form::label('national_id_4', __('form_fields.student.fields.national_id_4'), ['class' => 'col-sm-1 control-label']) !!}
            <div class="col-sm-2">
