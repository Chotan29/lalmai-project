<div class="tabbable">
    ...
    <div class="tab-content">
        <div id="generalInfo" class="tab-pane active">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        {!! Form::text('reg_no', null, ["placeholder" => "Numeric only", "class" => "form-control border-form input-mask-registration", "required", "inputmode" => "numeric", "pattern" => "[0-9]+", "title" => "Staff Id must be numeric (digits only)"]) !!}
                ...
                <div class="form-group">
                    {!! Form::label('qualification', 'Qualification <span class="text-danger">*</span>', ['class' => 'col-sm-2 control-label'], false) !!}
                    <div class="col-sm-4">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('postal_code', 'Postal Code', ['class' => 'col-sm-1 control-label']) !!}
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('temp_postal_code', 'Postal Code', ['class' => 'col-sm-1 control-label']) !!}
                    <div class="col-sm-2">
        ...
        <div id="profileImage" class="tab-pane">
            ...
            <div class="form-group">
                {!! Form::label('main_image', 'Staff Photo (Passport Size)'.(isset($data['row']) ? '' : ' <span class="text-danger">*</span>'), ['class' => 'col-sm-2 control-label'], false) !!}
                <div class="col-sm-10">
                    {!! Form::file('main_image', ["class" => "form-control border-form", "id" => "main_image", "accept" => "image/jpeg,image/png"]) !!}
                    @include('includes.form_fields_validation_message', ['name' => 'main_image'])

                    <div class="alert alert-warning" style="margin-top:12px; margin-bottom:8px; border-radius:8px;">
                        <b><i class="fa fa-info-circle"></i> Photo Rules:</b>
                        Passport size (portrait) &nbsp;|&nbsp; White background &nbsp;|&nbsp; JPG/PNG &nbsp;|&nbsp;
                        Minimum 240&times;320 px &nbsp;|&nbsp; Maximum 5MB &nbsp;|&nbsp; Old / blurry / tilted photo will be rejected.
                    </div>

                    <img id="staff-photo-preview" src="#" alt="Preview"
                         style="display:none; width:130px; border:1px solid #cdd6e0; border-radius:8px; padding:4px; background:#fff; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                </div>
            </div>
