                        ...
                        @if (isset($data['vehicle']) && $data['vehicle']->count() > 0)
                            ...
                            @foreach($data['vehicle'] as $vehicle)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $vehicle->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a class="btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => $vehicle->id]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $vehicle->id]) }}" class="btn-danger btn-sm bootbox-confirm">
