                                ...
                                <div class="align-right" style="font-weight: 600">
                                    ...
                                    @if(isset($row->display_group))
                                        ...
                                        @foreach($groups as $group)
                                            <div class="btn-group">
                                            <span data-toggle="dropdown" class="btn-primary btn-sm btn-info" >
                                    ...
                                    <hr class="hr-10">
                                    <a class="btn-primary btn-sm" href="{{ route($base_route.'.edit', ['id' => encrypt($row->id)]) }}"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Edit</a>
                                    <a class="btn-danger btn-sm bootbox-confirm" href="{{ route($base_route.'.delete', ['id' => encrypt($row->id)]) }}"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete</a>
