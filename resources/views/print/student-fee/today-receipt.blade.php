...
@section('css')
    ...
    <style>
        .today-receipt-layout .print-toolbar {
            width: 100%;
            clear: both;
            display: block;
            text-align: right;
        ...
        .today-receipt-layout .institution-header {
            width: 100% !important;
        ...
        .today-receipt-layout .institution-header-grid {
            width: 100% !important;
        ...
        .today-receipt-layout .institution-details,
        .today-receipt-layout .institution-name,
        .today-receipt-layout .institution-slogan,
        .today-receipt-layout .institution-contact {
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1">
                                <div class="widget-box transparent today-receipt-layout">
                                    <div class="print-toolbar hidden-print">
