...
@section('css')
    ...
    <style>
        ...
        .report-heading-center .receipt-copy {
            display: inline-block;
        }

        .institution-header .institution-details,
        .institution-header .institution-contact,
        .institution-header .institution-name,
        .institution-header .institution-slogan {
            text-align: center !important;
        }

        .institution-header .institution-header-grid {
            grid-template-columns: 140px 1fr 140px !important;
        }

        .widget-main .institution-header {
            width: 100% !important;
        ...
        .widget-main .institution-header .institution-header-grid {
            width: 100% !important;
