<div class="clearfix hidden-print ">
    <div class="easy-link-menu align-center">
        ...
        <a class="{!! request()->is('exam/mark-ledger/add')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('exam.mark-ledger.add') }}"><i class="fa fa-pencil-square" aria-hidden="true"></i>&nbsp;Prepare Ledger / Edit</a>
    </div>
</div>
<hr class="hr-6">