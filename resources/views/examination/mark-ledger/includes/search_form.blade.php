            ...
            <div class="panel-body">
                ...
                <div class="clearfix">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            {!! Form::select('years_id', $data['years'], request()->get('year'), ["class" => "form-control border-form","required"]) !!}
                            @include('includes.form_fields_validation_message', ['name' => 'years_id'])
                        </div>
                        {!! Form::label('months_id', 'Month', ['class' => 'col-sm-1 control-label']) !!}
                        <div class="col-sm-2">
                            {!! Form::select('months_id', $data['months'], request()->get('month'), ["class" => "form-control border-form","required"]) !!}
                            @include('includes.form_fields_validation_message', ['name' => 'months_id'])
                        </div>

                        {!! Form::label('exams_id', 'Exam', ['class' => 'col-sm-1 control-label']) !!}
                        <div class="col-sm-5">
                            {!! Form::select('exams_id', $data['exams'], request()->get('exam'), ["class" => "form-control border-form chosen-select","required"]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            {!! Form::select('faculty', $data['faculties'], request()->get('faculty'), ['class' => 'form-control chosen-select', 'onChange' => 'loadSemesters(this);']) !!}

                        </div>

                        <label class="col-sm-1 control-label">{{__('form_fields.student.fields.semester')}}</label>
                        <div class="col-sm-2">
                            <select name="semester_select" class="form-control semester_select" onChange="loadSubject(this)" data-selected="{{ request()->get('semester') }}">
                        ...
                        <div class="col-sm-3">
                            <select name="schedule_subject" class="form-control schedule_subject" onChange ="loadStudent(this)" data-selected="{{ request()->get('subject') }}">
