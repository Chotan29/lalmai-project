                ...
                <tr>
                        ...
                        <div class="btn-group">
                            ...
                            @if($assignment->end_date)
                                @if($assignment->end_date <= $now)
                                    <button data-toggle="dropdown" class="btn-danger btn-sm dropdown-toggle" >
                                        Time Over
                                    </button>
                                @else
                                    <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle" >
                                        Available
                                    </button>
                                @endif
                            @endif
                    ...
                    <td>
                        <div class="action-buttons">
                            @if(isset($approveStatus))
                                <a href="{{ route('user-guardian.students.assignment.answer.view', ['id'=>Crypt::encryptString($data['student_id']),'assignment' => $assignment->id, 'answer'=> $approveStatus->id]) }}" class="btn-primary btn-sm">
