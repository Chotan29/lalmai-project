                                    ...
                                    @foreach($data['visitor'] as $visitor)
                                        <tr>
                                            <td class="center first-child">
                                                <label>
                                                    <input type="checkbox" name="chkIds[]" value="{{ encrypt($visitor->id) }}" class="ace" />
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td>{{ $i }}</td>
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    <div class="btn-group">
                                                        <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $visitor->status == 'active'?"btn-success":"btn-warning" }}" >
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="{{ route($base_route.'.active', ['id' => encrypt($visitor->id)]) }}"> Visiting</a>
                                                            </li>

                                                            <li>
                                                                <a href="{{ route($base_route.'.in-active', ['id' => encrypt($visitor->id)]) }}"> Complete</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <a class="btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => encrypt($visitor->id)]) }}">
