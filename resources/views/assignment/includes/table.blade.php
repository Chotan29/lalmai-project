                ...
                @if (isset($data['assignment']) && $data['assignment']->count() > 0)
                    ...
                    @foreach($data['assignment'] as $assignment)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $assignment->status == 'active'?"btn-info":"btn-warning" }}" >
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('assignment.view', ['id' => encrypt($assignment->id)]) }}" class="btn-success btn-sm">
                                        <i class="ace-icon fa fa-eye bigger-130" title="View"></i>
                                    </a>

                                    <a href="{{ route('assignment.edit', ['id' => encrypt($assignment->id)]) }}" class="btn-success btn-sm">
                                        <i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
                                    </a>

                                    <a href="{{ route('assignment.delete', ['id' => encrypt($assignment->id)]) }}" class="btn-danger btn-sm bootbox-confirm" >
