                    ...
                    @if (isset($data['meetings']) && $data['meetings']->count() > 0)
                        ...
                        @foreach($data['meetings'] as $meeting)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $meeting->status == 'active'?"btn-info":"btn-warning" }}" >
                                ...
                                <td>
                                    ...
                                    <div class="action-buttons">
                                        <a href="{{ route($base_route.'.delete', ['id' => encrypt($meeting->id)]) }}" class="btn-danger btn-sm bootbox-confirm">
