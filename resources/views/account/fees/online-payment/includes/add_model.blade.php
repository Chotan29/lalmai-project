    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title title text-center fees_title" id="MasterTitle">Online Payment Collect / Verify</h4>
            </div>
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input type="hidden" name="payment_method" id="Gateway" value=""/>
