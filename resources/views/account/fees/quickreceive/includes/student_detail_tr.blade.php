    ...
    <div class="col-xs-12 col-sm-9">
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable" id="reg_no">
                        <a href="{{ route('student.view', ['id' => encrypt($student->id)]) }}">{{ $student->first_name.' '.
                ...
                <div class="profile-info-value">
                    <span class="editable" id="reg_no">
                        <a href="{{ route('student.view', ['id' => encrypt($student->id)]) }}" target="_blank">{{ ViewHelper::getStudentById($student->id) }}</a>
                    </span>
        ...
        <div class="col-xs-12 clearfix">
                <span class="editable" id="ledger_link">
                    <a href="{{ route('account.fees.due.view', ['id' => encrypt($student->id)]) }}" target="_blank" class="label label-primary label-lg white">
                        <i class="ace-icon fa fa-calculator  align-top bigger-125 icon-on-right"></i>
                        Pay Selected Due
                    </a>

                    <a href="{{ route('account.fees.collection.view', ['id' => encrypt($student->id)]) }}" target="_blank" class="label label-primary label-lg white">
                        <i class="ace-icon fa fa-eye  align-top bigger-125 icon-on-right"></i>
                        ViewLedger
                    </a>

                    <a class="label label-primary label-lg white inline" href="{{ route('print-out.fees.student-ledger', ['id' => encrypt($student->id)]) }}" target="_blank">
                        Print Ledger
                        <i class="ace-icon fa fa-print  align-top bigger-125 icon-on-right"></i>
                    </a>

                    <a class="label label-warning label-lg white inline" href="{{ route('print-out.fees.student-due-detail', ['id' => encrypt($student->id)]) }}" target="_blank">
                        Due Detail : {{ number_format($student->balance, 2) }}/-
                        <i class="ace-icon fa fa-print  align-top bigger-125 icon-on-right"></i>
                    </a>

                    <a class="label label-warning label-lg white inline" href="{{ route('print-out.fees.student-due', ['id' => encrypt($student->id)]) }}" target="_blank">
                        Total Balance
                        <i class="ace-icon fa fa-print  align-top bigger-125 icon-on-right"></i>
                    </a>

                    <a class="label label-success label-lg white inline" href="{{ route('print-out.fees.today-receipt-detail', ['id' => encrypt($student->id)]) }}" target="_blank">
                        Today Receipt Detail
                        <i class="ace-icon fa fa-print  align-top bigger-125 icon-on-right"></i>
                    </a>

                    <a class="label label-success label-lg white inline" href="{{ route('print-out.fees.today-receipt', ['id' => encrypt($student->id)]) }}" target="_blank">
                        Receipt
                        <i class="ace-icon fa fa-print  align-top bigger-125 icon-on-right"></i>
                    </a>
                </span>
