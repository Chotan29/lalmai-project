        ...
        <div>
            <span class="profile-picture">
                @if($data['student']->student_image != '')
                    <img id="avatar-small" class="editable img-responsive" alt="{{ $data['student']->title }}" src="{{ asset('images/studentProfile/' . $data['student']->student_image) }}" />
                @else
        ...
        <div class="profile-user-info profile-user-info-striped">
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable" id="reg_no"><a href="{{ route('student.view', ['id' => encrypt($data['student']->id)]) }}">{{ $data['student']->reg_no }}</a></span>
                </div>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable" id="student_name">
                        <a href="{{ route('student.view', ['id' => encrypt($data['student']->id)]) }}"> {{ $data['student']->first_name.' '.$data['student']->middle_name.' '. $data['student']->last_name }}</a>
                    </span>
                </div>
