<div class="row">
    <div class="col-xs-12">
        ...
        <div class="clearfix">
            ...
            <a class="label label-primary label-lg white" href="{{ route('print-out.payroll.staff-ledger', ['id' => encrypt($data['staff']->id)]) }}" target="_blank">
                Print Ledger
                             ...
                             @foreach($data['pay_salary'] as $pay_salary)
                                @if($pay_salary->salary_masters_id == $payrollMaster->id)
                                    ...
                                    <tr class="white-td even" role="row">
                                        ...
                                        <td>{{ $pay_salary->payment_method }}</td>
