                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a class="btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => encrypt($role->id)]) }}">
                                            <i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
                                        </a>
                                        @role('super-admin')
                                        <a href="{{ route($base_route.'.delete', ['id' => encrypt($role->id)]) }}" class="btn-danger btn-sm bootbox-confirm">
