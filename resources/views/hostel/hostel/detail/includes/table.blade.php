                    ...
                    @if (isset($data['rooms']) && $data['rooms']->count() > 0)
                        ...
                        @foreach($data['rooms'] as $room)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $room->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <div class="action-buttons">
                                        <a class="green open-EditRooms" data-toggle="modal"
                                           ...
                                           data-rate="{{ $room->rate_perbed }}">
                                            <i class="fa fa-pencil-square bigger-130" aria-hidden="true"></i>
                                        </a>
                                        <a href="{{ route($base_route.'.room.delete', ['id' => $room->id]) }}" class="btn-danger btn-sm bootbox-confirm">
