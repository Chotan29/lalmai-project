                            ...
                            <tr>
                                ...
                                <td>
                                    @if($resident->user_type==1)
                                        <a href="{{ route('student.view', ['id' => encrypt($resident->member_id)]) }}">
                                            {{ $regNumber = ViewHelper::getStudentById($resident->member_id) }}
                                        </a>
                                    @else
                                        <a href="{{ route('staff.view', ['id' => encrypt($resident->member_id)]) }}">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        @endif
                                        <a class="btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => $resident->id]) }}">
                                            <i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
                                        </a>

                                        <a href="{{ route($base_route.'.delete', ['id' => $resident->id]) }}" class="btn-danger btn-sm bootbox-confirm">
