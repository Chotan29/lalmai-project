                        ...
                        @if (isset($data['food_category']) && $data['food_category']->count() > 0)
                            ...
                            @foreach($data['food_category'] as $foodCategory)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $foodCategory->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a class="btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => $foodCategory->id]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => $foodCategory->id]) }}" class="btn-danger btn-sm bootbox-confirm">
