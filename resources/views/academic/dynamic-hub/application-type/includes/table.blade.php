                        ...
                        @if (isset($data['state']) && $data['state']->count() > 0)
                            ...
                            @foreach($data['state'] as $state)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $state->need_approve == '1'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $state->status == 'active'?"btn-info":"btn-warning" }}" >
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a class="btn-success btn-sm" href="{{ route($base_route.'.edit', ['id' => encrypt($state->id)]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
                                            </a>

                                            <a href="{{ route($base_route.'.delete', ['id' => encrypt($state->id)]) }}" class="btn-danger btn-sm bootbox-confirm">
