            ...
            <div class="panel-body">
                ...
                <div class="clearfix">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('title', null, ["placeholder" => "Enter Title", "class" => "form-control border-form form-control"]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            {!! Form::number('counter', null, ["placeholder" => "0", "class" => "form-control border-form form-control", "min"=>"0"]) !!}
                        </div>
