                            ...
                            <div class="tabbable  ">
                                    <ul class="nav nav-tabs  padding-18 hidden-print ">
                                        ...
                                        <li>
                                            <a data-toggle="tab" href="#documents">
                                                <i class="pink ace-icon fa fa-file bigger-140"></i>
                                                Documents
                                            </a>
                                        </li>
                                    ...
                                    <div class="tab-content no-border padding-24">
                                        <div id="profile" class="tab-pane in active">
                                           @include('user-staff.detail.includes.profile')
                                        </div><!-- /#home -->
                                        <div id="extrainfo" class="tab-pane">
                                            @include('user-staff.detail.includes.extrainfo')
                                        </div><!-- /#ExtraInfo -->

                                        <div id="academicInfo" class="tab-pane">
                                            @include('user-staff.detail.includes.academicInfo')
                                        </div><!-- /#AcademicInfo -->

                                        <div id="documents" class="tab-pane">
                                            @include('user-staff.detail.includes.documents')
                                        </div><!-- /#Documents -->

                                        <div id="notes" class="tab-pane">
                                            @include('user-staff.detail.includes.notes')
                                        </div><!-- /#Notes -->

                                        <div id="login-access" class="tab-pane">
                                            @include('user-staff.detail.includes.login-access')
                                        </div><!-- /#Login Detail -->
