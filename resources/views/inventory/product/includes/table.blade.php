                ...
                @if (isset($data['product']) && $data['product']->count() > 0)
                    ...
                    @foreach($data['product'] as $product)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn-primary btn-sm dropdown-toggle {{ $product->status == 'active'?"btn-info":"btn-warning" }}" >
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route($base_route.'.view', ['id' => encrypt($product->id)]) }}" class="btn-primary btn-sm btn-primary">
                                        <i class="ace-icon fa fa-eye bigger-130" title="View"></i>
                                    </a>

                                    <a href="{{ route($base_route.'.edit', ['id' => encrypt($product->id)]) }}" class="btn-primary btn-sm btn-success">
                                        <i class="ace-icon fa fa-pencil bigger-130" title="Edit"></i>
                                    </a>

                                    <a href="{{ route($base_route.'.delete', ['id' => encrypt($product->id)]) }}" class="btn-primary btn-sm btn-danger bootbox-confirm" >
