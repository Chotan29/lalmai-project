                            ...
                            <div class="tabbable  ">
                                    <ul class="nav nav-tabs  padding-18 hidden-print ">
                                        ...
                                        <li>
                                            <a data-toggle="tab" href="#transaction">
                                                <i class="blue ace-icon fa fa-exchange bigger-140"></i>
                                                Transaction
                                            </a>
                                        </li>
                                        ...
                                        {{--<li>
                                            <a data-toggle="tab" href="#service">
                                                <i class="blue ace-icon fa fa-briefcase bigger-140"></i>
                                                Service Taken
                                            </a>
                                        </li>--}}
                                        <li>
                                            <a data-toggle="tab" href="#documents">
                                                <i class="orange ace-icon fa fa-file bigger-140"></i>
                                                Document
                                            </a>
                                        </li>
                                    ...
                                    <div class="tab-content no-border padding-24">
                                        ...
                                        {{--<div id="service" class="tab-pane">
                                            @include($view_path.'.detail.includes.service')
                                        </div><!-- /#service -->--}}
